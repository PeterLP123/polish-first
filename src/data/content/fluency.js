...
export const fluencyDialogues = [
  ...
  dialogue("contract-terms", "🧾", "Clarifying contract terms", "You question an unexpected renewal clause before signing.", "Adviser", [
    ...
    ["Wyślemy przypomnienie sześć tygodni wcześniej, a wypowiedzenie trzeba złożyć miesiąc wcześniej.", "We'll send a reminder six weeks beforehand, and notice must be given one month in advance.", "Proszę wskazać ten zapis w umowie.", "Please show me that provision in the contract.", "Rozumiem. Chcę mieć ten termin na piśmie.", "I understand. I want that date in writing.", "Film zaczyna się o ósmej.", "The film starts at eight."],
    ["Pokażę ten zapis i dodam datę do potwierdzenia.", "I'll show you the provision and add the date to the confirmation.", "Dziękuję, to rozwiewa moją wątpliwość.", "Thank you, that clears up my concern.", "Czy wszystkie opłaty są już uwzględnione?", "Are all fees already included?", "Nie mam parasola.", "I don't have an umbrella."],
    ["Wszystkie opłaty są uwzględnione poza jednorazową opłatą aktywacyjną.", "All fees are included apart from a one-off activation fee.", "Nie widziałem jej w ofercie, więc proszę ją dopisać.", "I didn't see it in the offer, so please add it.", "Podpiszę umowę po otrzymaniu poprawionej wersji.", "I'll sign after receiving the corrected version.", "Szukam apteki.", "I'm looking for a pharmacy."],
  ]),
  ...
  dialogue("policy-consultation", "🏛️", "A public consultation", "You question a proposed city-centre traffic charge.", "Official", [
    ...
    ["Zbadaliśmy wpływ na osoby spoza miasta, a podobny system zmniejszył ruch w innych miastach.", "We studied the impact on people from outside the city, and a similar system reduced traffic elsewhere.", "Czy te miasta mają porównywalny transport publiczny?", "Do those cities have comparable public transport?", "Warto też uwzględnić lokalne warunki.", "Local conditions are also worth considering.", "Mam rezerwację na dwie noce.", "I have a reservation for two nights."],
    ["Te miasta mają podobny transport publiczny. Planujemy zwiększyć liczbę autobusów.", "Those cities have similar public transport. We plan to increase the number of buses.", "Czy nastąpi to przed wprowadzeniem opłaty?", "Will that happen before the charge is introduced?", "Jak zostaną sfinansowane dodatkowe połączenia?", "How will the additional services be funded?", "Jutro pracuję z domu.", "I'm working from home tomorrow."],
    ["Dodatkowe autobusy ruszą przed wprowadzeniem opłaty, a część dochodów z opłaty pokryje te koszty.", "The additional buses will start before the charge is introduced, and part of the charge revenue will cover the costs.", "To ważne, ale potrzebny jest konkretny harmonogram.", "That's important, but a specific schedule is needed.", "Czy dochody będą publicznie raportowane?", "Will the revenue be publicly reported?", "Ta zupa jest pyszna.", "This soup is delicious."],
    ["Przed uruchomieniem opublikujemy harmonogram, a po pierwszym roku raport.", "We'll publish the implementation schedule before launch and a report after the first year.", "Proponuję również przegląd po sześciu miesiącach.", "I also propose a review after six months.", "Dziękuję, prześlę uwagi przez formularz.", "Thank you, I'll submit comments through the form.", "Potrzebuję nowego telefonu.", "I need a new phone."],
  ]),
  dialogue("explaining-breakdown", "⚙️", "Explaining a failed process", "You help a colleague recover a rejected online application.", "Colleague", [
    ...
    ["W historii widzę numer kończący się na czterdzieści dwa.", "In the message history I can see a number ending in 42.", "Za jego pomocą możemy otworzyć szczegóły.", "We can use it to open the details.", "Wpisz numer w polu śledzenia sprawy.", "Enter the number in the case-tracking field.", "Mam alergię na orzechy.", "I'm allergic to nuts."],
    ["Widzę informację o brakującym załączniku.", "I see a note about a missing attachment.", "Kliknij link, żeby dodać dokument.", "Click the link to add the document.", "Nie musisz zaczynać całego wniosku od nowa.", "You don't need to start the whole application again.", "Spotkajmy się o szóstej.", "Let's meet at six."],
    ...
    ["Dobrze, poproszę pomoc techniczną o nowy link; teraz rozumiem, gdzie był problem.", "Okay, I'll ask technical support for a new link; now I understand where the problem was.", "Zapiszmy też termin, żeby link znów nie wygasł.", "Let's also note the deadline so the link doesn't expire again.", "Po dodaniu dokumentu sprawdź ekran potwierdzenia.", "After adding the document, check the confirmation screen.", "Lubię polską muzykę.", "I like Polish music."],
  ]),
];
