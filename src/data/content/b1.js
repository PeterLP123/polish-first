...
export const b1Dialogues = [
  dialogue("project-delay", "📊", "A project delay", "You agree a recovery plan with a colleague.", "Colleague", [
    ...
    ["Znaleźliśmy przyczynę, a naprawa przesunie termin o trzy dni.", "We found the cause, and the fix will move the deadline by three days.", "W takim razie musimy zmienić harmonogram.", "In that case we need to change the schedule.", "Które zadania możemy przesunąć?", "Which tasks can we move?", "Boli mnie gardło.", "My throat hurts."],
  ...
  dialogue("doctor-follow-up", "🩺", "A follow-up appointment", "You describe whether a treatment has helped.", "Doctor", [
    ...
    ["Badanie można zrobić jutro rano; proszę przyjść na czczo. Proszę wrócić z wynikami za tydzień.", "You can have the test tomorrow morning; please fast beforehand. Come back with the results in a week.", "Dobrze, umówię wizytę w recepcji.", "Okay, I'll book at reception.", "Czy do tego czasu mam dalej brać lek?", "Should I keep taking the medicine until then?", "Zgubiłem bagaż.", "I lost my luggage."],
  ]),
  dialogue("travel-rebooking", "🚧", "Rebooking a cancelled journey", "You arrange an alternative after a cancellation.", "Agent", [
    ...
    ["Mamy wolne miejsce na lot dziś o dwudziestej drugiej, który przylatuje jutro o siódmej rano.", "We have a seat on a flight at ten tonight that arrives at seven tomorrow morning.", "Czy jest to lot bezpośredni?", "Is it a direct flight?", "Gdzie jest przesiadka?", "Where is the connection?", "Ten sweter jest za mały.", "This jumper is too small."],
  ...
  dialogue("formal-complaint", "✉️", "Following up a complaint", "You call after receiving no reply to a formal complaint.", "Adviser", [
    ...
    ["Po otrzymaniu zdjęcia wyślemy potwierdzenie odbioru i odpowiemy w ciągu trzech dni roboczych.", "Once we receive the photo, we'll send a receipt confirmation and reply within three working days.", "Dziękuję, będę czekać na odpowiedź.", "Thank you, I'll wait for the reply.", "Proszę zanotować, że sprawa jest pilna.", "Please note that the matter is urgent.", "Chętnie pójdę do kina.", "I'd happily go to the cinema."],
  ]),
  dialogue("community-meeting", "🌍", "A community meeting", "You discuss a neighbourhood traffic proposal.", "Resident", [
    ...
    ["Dane z podobnych projektów są obiecujące. Próba miałaby potrwać trzy miesiące.", "Data from similar projects is encouraging. The trial would last three months.", "To rozsądny kompromis.", "That's a reasonable compromise.", "Jak zostaną ocenione rezultaty?", "How will the results be assessed?", "Boli mnie kolano.", "My knee hurts."],
    ...
    ["Uwagi można wysyłać do końca miesiąca.", "Comments can be sent until the end of the month.", "Dobrze, prześlę krótkie podsumowanie.", "Okay, I'll send a short summary.", "Czy link do formularza jest na stronie miasta?", "Is the link to the form on the city website?", "Rachunek, proszę.", "The bill, please."],
  ]),
  dialogue("clearing-the-air", "🤝", "Clearing the air", "You resolve tension after plans changed repeatedly.", "Friend", [
    ...
    ["Powinnam była dać ci znać wcześniej.", "I should have let you know earlier.", "Właśnie tego potrzebuję następnym razem.", "That's exactly what I need next time.", "Łatwiej mi przyjąć zmianę planów, kiedy wiem o niej wcześniej.", "It is easier for me to accept a change of plans when I know about it earlier.", "Pociąg odjeżdża o ósmej.", "The train leaves at eight."],
