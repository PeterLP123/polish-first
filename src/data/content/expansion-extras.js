...
export const expansionDialogues = [
  dialogue("clothes-return", "👕", "Returning a jacket", "You return an unsuitable jacket with the receipt.", "Assistant", [
    ...
    ["Woli pan wymianę czy zwrot?", "Would you prefer an exchange or refund?", "Poproszę zwrot pieniędzy.", "A refund, please.", "Chętnie zobaczę ten model w innym kolorze.", "I'd like to see this style in another colour."],
    ["Dobrze, za chwilę wszystko załatwimy.", "All right, we'll have everything sorted in a moment.", "Dziękuję za pomoc.", "Thank you for your help.", "Dobrze, będę czekać.", "Okay, I'll wait."]]),
  dialogue("course-enrolment", "📚", "Joining a course", "You ask a language school about an evening course.", "Coordinator", [
    ...
    ["Zajęcia zaczynają się o osiemnastej, można dołączyć online, a kurs trwa dwanaście tygodni.", "Classes start at six, you can join online, and the course lasts twelve weeks.", "Ile kosztuje cały kurs?", "How much is the full course?", "Czy podręcznik jest w cenie?", "Is the textbook included?"],
    ["Kurs kosztuje tysiąc dwieście złotych, podręcznik jest w cenie. Najpierw proszę zrobić test poziomujący.", "The course costs twelve hundred zloty, and the textbook is included. First please take a placement test.", "Gdzie znajdę ten test?", "Where can I find the test?", "Zrobię go jeszcze dziś.", "I'll do it today."],
    ["Test jest na naszej stronie. Potem może się pan zapisać przez internet.", "The test is on our website. Then you can enrol online.", "Dziękuję, wszystko rozumiem.", "Thank you, I understand everything.", "Świetnie, zapiszę się wieczorem.", "Great, I'll enrol this evening."]]),
  dialogue("office-deadline", "💼", "Moving a deadline", "You coordinate a delayed task with a colleague.", "Colleague", [
    ...
    ["Możemy przesunąć termin, ale do której godziny go skończysz?", "We can move the deadline, but what time will you finish it?", "Wyślę go przed czwartą.", "I'll send it before four.", "Potrzebuję czasu do końca dnia.", "I need until the end of the day."],
  ...
  dialogue("internet-support", "📱", "Calling internet support", "Your home internet stopped working.", "Support", [
    ...
    ["Wyślemy powiadomienie. Usługa powinna działać przed osiemnastą.", "We'll send a notification. The service should work before six.", "Dziękuję za informację.", "Thank you for the information.", "Dobrze, sprawdzę wieczorem.", "Okay, I'll check this evening."]]),
  dialogue("flat-viewing", "🏢", "Viewing a flat", "You ask a landlord practical questions.", "Landlord", [
    ...
    ["Kuchnia jest obok. Czynsz wynosi trzy tysiące złotych.", "The kitchen is next door. The rent is three thousand zloty.", "Czy rachunki są wliczone?", "Are bills included?", "Ile wynosi kaucja?", "How much is the deposit?"],
    ["Rachunki płaci się osobno, a kaucja wynosi trzy tysiące złotych.", "Bills are paid separately, and the deposit is three thousand zloty.", "Ile kosztują średnio?", "How much do they cost on average?", "Czy ogrzewanie jest miejskie?", "Is the heating municipal?"],
    ["Rachunki kosztują średnio pięćset złotych, a ogrzewanie jest miejskie. W budynku obowiązuje cisza po dziesiątej.", "Bills average five hundred zloty, the heating is municipal, and the building is quiet after ten.", "Rozumiem, to nie problem.", "I understand, that's not a problem.", "Czy można mieć kota?", "Are cats allowed?"],
    ["Można mieć kota. Mieszkanie jest wolne od przyszłego tygodnia.", "Cats are allowed. The flat is available next week.", "Chciałbym je wynająć.", "I'd like to rent it.", "Kiedy możemy podpisać umowę?", "When can we sign the contract?"]]),
  dialogue("event-tickets", "🎭", "Buying event tickets", "You choose seats for a concert.", "Cashier", [
    ...
    ["Z wybranej części sali dobrze widać scenę. Potwierdzenie rezerwacji wyślę na podany adres.", "The stage is clearly visible from the selected section. I'll send the booking confirmation to the address provided.", "Dziękuję, zaraz zapłacę.", "Thank you, I'll pay now.", "Proszę wysłać je mailem.", "Please send it by email."]]),
  dialogue("weekend-hike", "🌲", "Planning a hike", "You ask at a visitor centre about a route.", "Ranger", [
    ...
    ["Trasa jest bezpieczna, ale szlak może być śliski. Proszę założyć solidne buty oraz zabrać wodę i kurtkę.", "The route is safe, but the trail may be slippery. Wear sturdy shoes and take water and a jacket.", "Mamy wszystko w plecaku.", "We have everything in the backpack.", "Gdzie można kupić mapę?", "Where can we buy a map?"],
    ["Jeśli potrzebujecie mapy, można ją kupić tutaj. Na rozwidleniu proszę skręcić w prawo.", "If you need a map, you can buy one here. At the fork, turn right.", "Czy szlak jest oznaczony?", "Is the trail marked?", "Rozumiem, pójdziemy w prawo.", "I understand, we'll go right."],
    ["Szlak jest oznaczony na czerwono. Proszę wrócić przed zachodem słońca.", "The trail is marked in red. Please return before sunset.", "Oczywiście, będziemy uważać.", "Of course, we'll be careful.", "Dziękujemy za radę.", "Thank you for the advice."]]),
  dialogue("choosing-hotel", "⚖️", "Choosing a hotel", "You compare two places with a friend.", "Friend", [
    ...
    ["Oba mają dobre oceny.", "Both have good ratings.", "W takim razie wybierzmy pierwszy.", "In that case let's choose the first.", "Mimo wszystko wybieram tańszą opcję.", "All things considered, I'll choose the cheaper option."],
  ...
  dialogue("telling-a-story", "🕰️", "Telling what happened", "A friend asks about your difficult journey.", "Friend", [
    ...
    ["I co zrobiłeś?", "And what did you do?", "Poprosiłem konduktora o pomoc.", "I asked the conductor for help.", "Poszedłem do punktu informacji.", "I went to the information desk."],
  ...
  dialogue("damaged-order", "🧾", "A damaged order", "You report a damaged delivery.", "Agent", [
    ...
    ["Kurier przyjedzie jutro po południu. Wyślę potwierdzenie mailem.", "The courier will come tomorrow afternoon. I'll send confirmation by email.", "Dziękuję za rozwiązanie problemu.", "Thank you for solving the problem.", "Dobrze, czekam na wiadomość.", "Okay, I'll wait for the message."]]),
  dialogue("office-application", "🏛️", "Submitting an application", "You submit a form at a public office.", "Clerk", [
    ...
    ["Proszę podpisać w zaznaczonym miejscu na drugiej stronie. Trzeba jeszcze zapłacić opłatę.", "Sign in the marked place on the second page. You still need to pay the fee.", "Czy mogę zapłacić kartą?", "Can I pay by card?", "Ile wynosi opłata?", "How much is the fee?"],
    ["Opłata wynosi sto złotych i można zapłacić kartą. Dokument będzie gotowy za dwa tygodnie.", "The fee is one hundred zloty and you can pay by card. The document will be ready in two weeks.", "Czy dostanę powiadomienie?", "Will I receive a notification?", "Dziękuję, zapiszę termin.", "Thank you, I'll note the date."]]),
  dialogue("giving-advice", "🧭", "Giving practical advice", "A friend asks how to prepare for a trip.", "Friend", [
    ...
    ["Kiedy najlepiej wyjść?", "When is it best to leave?", "Najlepiej wcześnie rano.", "Early morning is best.", "Najlepiej wyjść przed ósmą.", "It's best to leave before eight."],
